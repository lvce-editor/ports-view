...
test('virtual dom: renders the five-column table and all requested fields', () => {
...
test('virtual dom: renders active and inactive status icons accessibly', () => {
...
test('virtual dom: renders selected and odd rows', () => {
...
test('virtual dom: uses the shared class for every table column', () => {
...
test('virtual dom: renders empty and populated bodies', () => {
...
test('virtual dom: renders add button, editor, and validation', () => {
...
test('virtual dom: header contains all labels', () => {
  const header = getPortsTableHeaderVirtualDom()
...
test('virtualization rendering: renders only visible items from a thousand ports', () => {
...
test('virtualization rendering: renders the stored visible rows', () => {
  const state = setPorts(createTestState(), [
...
test('virtualization rendering: css positions partial rows and sizes the table', () => {
...
test('render protocol: emits dom, css, and patches commands', () => {
...
test('render protocol: diff helpers cover dom and css state', () => {
...
test('render protocol: registers interaction event listeners and commands', () => {
...
test('render protocol: creates, diffs, and renders registered view state', () => {
