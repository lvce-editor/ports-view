...
test('virtual list: only exposes enough rows for the viewport', () => {
...
test('virtual list: calculates a middle range', () => {
...
test('virtual list: clamps overscroll', () => {
...
test('virtual list: handles empty and zero-height lists', () => {
...
test('virtual list: refreshes visible row data and selection after port and focus changes', () => {
...
test('virtual list: wheel supports pixel and line modes', () => {
  const state = setPorts(createTestState(), manyPorts)
...
test('virtual list: wheel uses the state multiplier for line and page modes but not pixel mode', () => {
...
test('virtual list: resize recalculates visible rows', () => {
...
test('focus: moves and clamps focus', () => {
  const state = setPorts(createTestState(), manyPorts)
...
test('focus: scrolls focused rows into view', () => {
...
test('focus: moves backward from no selection to the last row', () => {
...
test('focus: keeps empty state unfocused', () => {
